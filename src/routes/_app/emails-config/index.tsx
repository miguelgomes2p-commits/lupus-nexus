...
import { Plus, Mail, Pencil, Trash2, Send, Copy } from "lucide-react";
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Modelos editáveis (boas-vindas, lembretes, etc). Variáveis suportadas: {{variavel}}"
        action={
            ...
            <Card key={s.id} className="p-4 sm:p-5 glass hover-lift">
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex flex-col gap-1 shrink-0">
                  ...
                  <Button size="icon" variant="ghost" onClick={() => { if (confirm(`Excluir "${s.name}"?`)) remove(s.id); }}>
